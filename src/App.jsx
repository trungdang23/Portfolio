      ...
      <footer className="border-t border-[#00f0ff]/10 py-10 bg-[#070709] relative z-30">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 border border-slate-800 rounded flex items-center justify-center hover:border-[#00f0ff] text-slate-400 hover:text-[#00f0ff] transition-all duration-300">
